...
<body class="header_sticky header-style-1 has-menu-extra">
  ...
  <div id="site-header-wrap">
            ...
            <header id="header" class="header header-container clearfix">
                <div class="container clearfix" id="site-header-inner">
                    ...
                    <ul class="menu-extra">
                        <li class="box-search">
                            <a class=""  href="sign_out.php">Signout</a>&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="title-section margin-bottom-41">
                            <h2 class="title">Welcome <span style="color:red"><?php echo $_SESSION['user'];?></span></h2>
                        </div>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content" style="margin-top: 135px;">
      ...
      <center><input type="submit" name="submit" value="Login" class="btn-primary btn-lg"></center>
      </form>
    </div>
    ...
    <div class="modal-content" style="margin-top: 135px;">
      ...
      <form action="signup.php" method="post">
        ...
        <div class="form-group">
            ...
            <center><div class="text-center">Already have an account? <a href="#" data-toggle="modal" data-target="#myModal" data-dismiss="modal" aria-label="Close">Login here</a></div></center>
