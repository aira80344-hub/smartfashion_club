...
<body class="header_sticky header-style-1 has-menu-extra">
  ...
  <div id="site-header-wrap">
      ...
      <center><input type="submit" name="login" value="Login" class="btn-info btn-lg"></center>
      </form>
    </div>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content" style="margin-top: 135px;">
      ...
      <center><input type="submit" name="submit" value="Login" class="btn btn-info btn-lg btn-block signup-btn"></center>
      </form>
    </div>
